...
#define slot_is_unevaluated		name(slot_is_unevaluated)
 ...
 * instruction.
 *
 * On sparc, we need this so that ldd and std are 8-byte aligned.
 */
...
#ifdef HAVE_CODEGEN
#define checkpoint_num_offset	(offsetof(struct data, u_.codegen.unoptimized_code) - sizeof(char *))
#else
#define checkpoint_num_offset	0
#endif
