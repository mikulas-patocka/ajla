...
#define OPCODE_FIXED_OP_C			 30
#define OPCODE_FIXED_OP_C_add			30
#define OPCODE_FIXED_OP_C_subtract		31
#define OPCODE_FIXED_OP_C_multiply		32
#define OPCODE_FIXED_OP_C_divide		33
#define OPCODE_FIXED_OP_C_divide_alt1		34
#define OPCODE_FIXED_OP_C_udivide		35
#define OPCODE_FIXED_OP_C_udivide_alt1		36
#define OPCODE_FIXED_OP_C_modulo		37
#define OPCODE_FIXED_OP_C_modulo_alt1		38
#define OPCODE_FIXED_OP_C_umodulo		39
#define OPCODE_FIXED_OP_C_umodulo_alt1		40
#define OPCODE_FIXED_OP_C_power			41
#define OPCODE_FIXED_OP_C_and			42
#define OPCODE_FIXED_OP_C_or			43
#define OPCODE_FIXED_OP_C_xor			44
#define OPCODE_FIXED_OP_C_shl			45
#define OPCODE_FIXED_OP_C_shr			46
#define OPCODE_FIXED_OP_C_ushr			47
#define OPCODE_FIXED_OP_C_rol			48
#define OPCODE_FIXED_OP_C_ror			49
#define OPCODE_FIXED_OP_C_bts			50
#define OPCODE_FIXED_OP_C_btr			51
#define OPCODE_FIXED_OP_C_btc			52
#define OPCODE_FIXED_OP_C_equal			53
#define OPCODE_FIXED_OP_C_not_equal		54
#define OPCODE_FIXED_OP_C_less			55
#define OPCODE_FIXED_OP_C_less_equal		56
#define OPCODE_FIXED_OP_C_uless			57
#define OPCODE_FIXED_OP_C_uless_equal		58
#define OPCODE_FIXED_OP_C_bt			59
#define OPCODE_FIXED_OP_UNARY			 60
#define OPCODE_FIXED_OP_not			60
#define OPCODE_FIXED_OP_neg			61
#define OPCODE_FIXED_OP_inc			62
#define OPCODE_FIXED_OP_dec			63
#define OPCODE_FIXED_OP_bswap			64
#define OPCODE_FIXED_OP_bswap_alt1		65
#define OPCODE_FIXED_OP_brev			66
#define OPCODE_FIXED_OP_brev_alt1		67
#define OPCODE_FIXED_OP_bsf			68
#define OPCODE_FIXED_OP_bsf_alt1		69
#define OPCODE_FIXED_OP_bsr			70
#define OPCODE_FIXED_OP_bsr_alt1		71
#define OPCODE_FIXED_OP_popcnt			72
#define OPCODE_FIXED_OP_popcnt_alt1		73
#define OPCODE_FIXED_OP_to_int			74
#define OPCODE_FIXED_OP_uto_int			75
#define OPCODE_FIXED_OP_from_int		76
#define OPCODE_FIXED_OP_ufrom_int		77
#define OPCODE_FIXED_OP_N			 78
#define OPCODE_FIXED_OP_move			78
#define OPCODE_FIXED_OP_copy			79
#define OPCODE_FIXED_OP_ldc			80
#define OPCODE_FIXED_OP_ldc16			81

#define OPCODE_FIXED_TYPE_MULT		82
...
#define OPCODE_INT_OP_C				 21
#define OPCODE_INT_OP_C_add			21
#define OPCODE_INT_OP_C_subtract		22
#define OPCODE_INT_OP_C_multiply		23
#define OPCODE_INT_OP_C_divide			24
#define OPCODE_INT_OP_C_divide_alt1		25
#define OPCODE_INT_OP_C_modulo			26
#define OPCODE_INT_OP_C_modulo_alt1		27
#define OPCODE_INT_OP_C_power			28
#define OPCODE_INT_OP_C_and			29
#define OPCODE_INT_OP_C_or			30
#define OPCODE_INT_OP_C_xor			31
#define OPCODE_INT_OP_C_shl			32
#define OPCODE_INT_OP_C_shr			33
#define OPCODE_INT_OP_C_bts			34
#define OPCODE_INT_OP_C_btr			35
#define OPCODE_INT_OP_C_btc			36
#define OPCODE_INT_OP_C_equal			37
#define OPCODE_INT_OP_C_not_equal		38
#define OPCODE_INT_OP_C_less			39
#define OPCODE_INT_OP_C_less_equal		40
#define OPCODE_INT_OP_C_bt			41
#define OPCODE_INT_OP_UNARY			 42
#define OPCODE_INT_OP_not			42
#define OPCODE_INT_OP_neg			43
#define OPCODE_INT_OP_inc			44
#define OPCODE_INT_OP_dec			45
#define OPCODE_INT_OP_bsf			46
#define OPCODE_INT_OP_bsr			47
#define OPCODE_INT_OP_popcnt			48
#define OPCODE_INT_OP_popcnt_alt1		49
#define OPCODE_INT_OP_to_int			50
#define OPCODE_INT_OP_from_int			51
#define OPCODE_INT_OP_N				 52
#define OPCODE_INT_OP_move			52
#define OPCODE_INT_OP_copy			53
#define OPCODE_INT_OP_ldc			54
#define OPCODE_INT_OP_ldc16			55

#define OPCODE_INT_TYPE_MULT		56
