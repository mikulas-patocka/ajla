...
#define IMM_PURPOSE_ADC_SBB		10
#define IMM_PURPOSE_CMP			11
#define IMM_PURPOSE_CMP_LOGICAL		12
#define IMM_PURPOSE_AND			13
#define IMM_PURPOSE_OR			14
#define IMM_PURPOSE_XOR			15
#define IMM_PURPOSE_ANDN		16
#define IMM_PURPOSE_TEST		17
#define IMM_PURPOSE_JMP_2REGS		18
#define IMM_PURPOSE_JMP_2REGS_LOGICAL	19
#define IMM_PURPOSE_MUL			20
#define IMM_PURPOSE_CMOV		21
#define IMM_PURPOSE_MOVR		22
#define IMM_PURPOSE_BITWISE		23
#define IMM_PURPOSE_ADD_TRAP		24
#define IMM_PURPOSE_SUB_TRAP		25
...
static unsigned alu_purpose(unsigned alu)
{
	unsigned purpose =
		...
		alu == ALU_ADC ? IMM_PURPOSE_ADC_SBB :
		alu == ALU_SUB ? IMM_PURPOSE_SUB :
		alu == ALU_SBB ? IMM_PURPOSE_ADC_SBB :
...
#endif
#if defined(ARCH_MIPS32)
#if MIPS_R6
		str_add_string(&hex, &hexl, "	.module	arch=mips32r6\n");
#else
		str_add_string(&hex, &hexl, "	.module	arch=mips32r2\n");
#endif
#endif
